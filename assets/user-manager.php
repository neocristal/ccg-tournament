...
if (!is_user_logged_in()) {
    echo "<p>Please log in to manage your tournament team.</p>";
    get_footer();
    return;
}
...
<div class="ccg-dashboard">
    <h2>Your Tournament Team</h2>
    <button class="ccg-add-btn">+ Add Player</button>
    <table class="ccg-table">
        <thead><tr><th>Avatar</th><th>Name</th><th>Nickname</th><th>Team</th><th>Status</th><th>Deck</th><th>Actions</th></tr></thead>
        <tbody>
            <?php foreach ($players as $p): ?>
                <tr>
                    <td><img src="<?= esc_url($p->avatar_url) ?>" width="40" style="border-radius: 50%"></td>
                    <td><?= esc_html($p->name) ?></td>
                    <td><?= esc_html($p->nickname) ?></td>
                    <td><?= esc_html($p->team) ?></td>
                    ...
                    <td>
                        <button class="ccg-edit-btn"
                            ...
                            data-avatar="<?= esc_attr($p->avatar_url) ?>"
                            data-team="<?= esc_attr($p->team) ?>">✏️</button>
...
<div class="ccg-modal" id="ccg-modal">
    <div class="ccg-modal-content">
        <form id="ccg-player-form">
            ...
            <p><label>Team<br><input type="text" id="player_team"></label></p>
